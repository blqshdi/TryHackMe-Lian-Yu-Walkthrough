...
![Lian Yu Banner](https://i.imgur.com/your-banner-image.png)

![Platform](https://img.shields.io/badge/Platform-TryHackMe-red)
![Difficulty](https://img.shields.io/badge/Difficulty-Easy-green)
![Type](https://img.shields.io/badge/Type-CTF-blue)
![Focus](https://img.shields.io/badge/Focus-Enumeration%20%7C%20PrivEsc-purple)
...
SSH login via recovered credentials
Privilege escalation (pkexec abuse)
💬 Conclusion

This machine demonstrates the importance of deep enumeration and hidden file analysis. Most of the path was achieved through careful inspection of FTP files and steganography extraction.
